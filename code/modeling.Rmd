...
ggplot(data_city, aes(x = RentControl, y = MedianRent)) +
  geom_boxplot()+
  ggtitle("Median Rent v.s. Rent Control in 2019") +
...
ggplot(data_city, aes(x = RentControl, y = MedianRentIncreasingRate)) +
  geom_boxplot()+
  ggtitle("MedianRent Increasing Rate v.s. Rent Control in 2019") +
...
ggplot(data_city, aes(x = RentControl, y = MedianHouseholdIncome)) +
  geom_boxplot()+
  ggtitle("Median Household Income v.s. Rent Control in 2019") +
